...
class DomainModelProvider {
  ...
  static String DOMAIN_MODEL_NSURI = ""
  static String DOMAIN_MODEL_INSTANCE_FILE = ""

  static EPackage DOMAIN_MODEL
  static Resource DOMAIN_INSTANCE_RESOURCE


  static List<IDomainModelUser> domainModelUsers =
